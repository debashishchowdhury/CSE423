...
def draw_house_decorations():
    ...
    # Simple chandelier in center of hallway
...
def draw_hud():
    ...
    draw_text(x0, y0 - 112, "WASD: Move  Arrows: Camera  B: Boost  R: Restart")
...
def special_down(key, x, y):
    ...
    global pdir, TPS_DIST, TPS_HEIGHT
...
def main():
    ...
    glutCreateWindow(b"Scooby Doo: Mystery Hunt - OpenGL Prototype")
